    ...
    >
      ...
      >
        <div className="flex justify-between items-start gap-3">
          ...
          {/* Remove and expand/collapse, inline */}
          <div className="flex items-center gap-1 flex-shrink-0">
          <button
            data-testid="event-card-remove"
            className="p-1 hover:bg-gray-200 rounded transition-colors focus:outline-none focus:ring-2 focus:ring-black flex-shrink-0"
