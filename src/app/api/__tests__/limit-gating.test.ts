...
// The two legacy non-scan LLM routes derive getLlmKey() before the gate; give them a
// community key so they reach the authority rather than failing closed first.
process.env.OPENROUTER_COMMUNITY_KEY = 'sk-test';
